    ...
    size_t *hkdfOutputLen)
{
    ...
    /* changed by scpf */
    if(sss_derived_keyObject->cipherType != kSSS_CipherType_AES)
    {
        retval =
    ...
    {
        /* TODO_scpf check length */
        printf("hkdfKeyLen = %d\r\n", hkdfKeyLen);
        if(hkdfKeyLen < *hkdfOutputLen)
        {
            memcpy(hkdfOutput, hkdfKey, hkdfKeyLen);
            *hkdfOutputLen = hkdfKeyLen;
        }else
        {
