...
//     void *p_rng)
// {
//     printf("Hello from mbedtls_ecdh_gen_public SSS HOOK\r\n");
...
//     printf("Get key object\r\n");

//     status = sss_key_object_get_handle(grp->pSSSObject, 4);
...
//     printf("get key objec success full\r\n");

//     if(grp->pSSSObject->objectType == kSSS_KeyPart_Pair &&
...
//         //     printf("Get key successful\r\n");
//         //     return mbedtls_ecp_point_read_binary(
//         //         grp, Q, &publickey[headerLen], publickeylen);
//         // }
//         // else {
//         //     printf("Nothing works fucking NXP\r\n");
//         //     return 1;
//         // }
//     }

//     // status = sss_key_object_allocate_handle(grp->pSSSObject, 
//     //                                         4, 
//     //                                         kSSS_KeyPart_Pair,
...
//     /* Get pre-defined (allocated) key slot */
...
//     // else 
// //    printf("Realy nothing works fucking NXP\r\n");
//     return 0;
// }
